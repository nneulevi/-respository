...
class Transaction_Zhuce(SerialTransaction):
    ...
    @task
    def task_89(self):
        url = "http://26.234.8.159:5173/src/views/ce/Register.vue"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': '*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/src/router/index.ts'}
        params = {}
        # null
        data = None
    ...
    def task_90(self):
        url = "http://26.234.8.159:5173/src/views/ce/Register.vue"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': '*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/src/views/ce/Register.vue'}
        params = {}
        params['type']='style'
        params['index']='0'
        params['scoped']='d4b1f277'
        params['vue']=''
        params['lang.css']=''
        # null
        data = None
