...
class Transaction_Kecheng1(SerialTransaction):
    '''
    ...
    @task
    def task_53(self):
        url = "http://26.234.8.159:5173/src/views/Course/CourseList.vue"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': '*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/src/router/index.ts'}
        params = {}
        # null
        data = None
    ...
    @task
    def task_54(self):
        url = "http://26.234.8.159:5173/src/views/Course/CourseDialog.vue"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': '*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/src/views/Course/CourseList.vue'}
        params = {}
        # null
        data = None
        res = self.get(url, headers=headers, params=params, data=data)
    ...
    @task
    def task_55(self):
        url = "http://26.234.8.159:5173/src/api/course.js"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': '*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/src/views/Course/CourseList.vue'}
        params = {}
        # null
        data = None
    ...
    def task_57(self):
        url = "http://26.234.8.159:5173/src/views/Course/CourseDialog.vue"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': '*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/src/views/Course/CourseDialog.vue'}
        params = {}
        params['type']='style'
        params['index']='0'
        params['scoped']='7e1001d6'
        params['vue']=''
        params['lang.css']=''
        # null
        data = None
    ...
    @task
    def task_58(self):
        url = "http://localhost:8080/getCoursesByFilter"
        headers = {'Host': 'localhost:8080', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'application/json, text/plain, */*', 'Accept-Language': 'en-US,en;q=0.5', 'Origin': 'http://26.234.8.159:5173', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/', 'Sec-Fetch-Dest': 'empty', 'Sec-Fetch-Mode': 'cors', 'Sec-Fetch-Site': 'cross-site'}
        params = {}
        params['page']='1'
        params['size']='5'
    ...
    @task
    def task_60(self):
        url = "http://26.234.8.159:5173/src/assets/videos/a442db10-0398-4ffa-ac5d-709930385eab.webp"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'image/avif,image/webp,*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/course'}
        params = {}
        # null
        data = None
        res = self.get(url, headers=headers, params=params, data=data)
    ...
    @task
    def task_61(self):
        url = "http://26.234.8.159:5173/src/assets/videos/421ef18c-8bb8-4a71-a487-33ddf1a1d3b0.jpg"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'image/avif,image/webp,*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/course'}
        params = {}
        # null
        data = None
    ...
    @task
    def task_62(self):
        url = "http://26.234.8.159:5173/src/assets/videos/1c15fcbb-4f05-4410-bc81-944195b3085b.jpg"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'image/avif,image/webp,*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/course'}
        params = {}
        # null
        data = None
    ...
    @task
    def task_63(self):
        url = "http://26.234.8.159:5173/src/assets/videos/cfdac602-7b57-4dff-9f32-7fbe7ba81234.webp"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'image/avif,image/webp,*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/course'}
        params = {}
        # null
        data = None
    ...
    @task
    def task_64(self):
        url = "http://26.234.8.159:5173/src/assets/videos/829f3067-a5f3-4553-a236-b27277df9bb9.png"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'image/avif,image/webp,*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/course'}
        params = {}
        # null
        data = None
    ...
    @task
    def task_65(self):
        url = "http://26.234.8.159:5173/src/assets/videos/336fd4b9-8681-4b70-88ab-057afd53b4a7.jpg"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'image/avif,image/webp,*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/course'}
        params = {}
        # null
        data = None
    ...
    @task
    def task_66(self):
        url = "http://26.234.8.159:5173/src/assets/videos/be63418f-dace-4b2e-a1d1-02c9c5b7a5fb.webp"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'image/avif,image/webp,*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/course'}
        params = {}
        # null
        data = None
    ...
    @task
    def task_67(self):
        url = "http://26.234.8.159:5173/src/assets/videos/f8c96e72-a1d2-4636-ad87-527180bb9e88.png"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'image/avif,image/webp,*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/course'}
        params = {}
        # null
        data = None
    ...
    @task
    def task_68(self):
        url = "http://26.234.8.159:5173/src/assets/videos/ec98dd47-aca0-43c1-adcd-6228114891cf.png"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'image/avif,image/webp,*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/course'}
        params = {}
        # null
        data = None
    ...
    @task
    def task_69(self):
        url = "http://26.234.8.159:5173/src/assets/videos/6aa9c522-e2ea-4205-8195-e8988e001395.jpg"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'image/avif,image/webp,*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/course'}
        params = {}
        # null
        data = None
    ...
    @task
    def task_70(self):
        url = "http://26.234.8.159:5173/src/assets/videos/4cddcfa9-3d82-497f-8e2c-72d40ceb661d.webp"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'image/avif,image/webp,*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/course'}
        params = {}
        # null
        data = None
    ...
    @task
    def task_71(self):
        url = "http://26.234.8.159:5173/src/assets/videos/c3ac3c68-9813-4fbe-89e0-e51adf3ce445.png"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'image/avif,image/webp,*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/course'}
        params = {}
        # null
        data = None
    ...
    @task
    def task_72(self):
        url = "http://26.234.8.159:5173/src/views/Course/CourseDetail.vue"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': '*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/src/router/index.ts'}
        params = {}
        # null
        data = None
    ...
    def task_73(self):
        url = "http://26.234.8.159:5173/src/views/Course/CourseDetail.vue"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': '*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/src/views/Course/CourseDetail.vue'}
        params = {}
        params['type']='style'
        params['index']='0'
        params['scoped']='7fe28327'
        params['vue']=''
        params['lang.scss']=''
        # null
        data = None
    ...
    @task
    def task_74(self):
        url = "http://localhost:8080/getCourse"
        headers = {'Host': 'localhost:8080', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'application/json, text/plain, */*', 'Accept-Language': 'en-US,en;q=0.5', 'Origin': 'http://26.234.8.159:5173', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/', 'Sec-Fetch-Dest': 'empty', 'Sec-Fetch-Mode': 'cors', 'Sec-Fetch-Site': 'cross-site'}
        params = {}
        params['id']='13'
        # null
    ...
    @task
    def task_81(self):
        url = "http://26.234.8.159:5173/src/assets/videos/85739a13-80b8-4206-bf05-d44b1617dae7.webp"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'image/avif,image/webp,*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/course'}
        params = {}
        # null
        data = None
...
class WebrunnerAction(BrowserAction):
    ...
    @task(1)
    @transaction("kecheng1")
    def task_kecheng1(self):
        # 执行事务
        Transaction_Kecheng1(self).run()
