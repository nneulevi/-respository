...
class Transaction_Zixun(SerialTransaction):
    '''
    ...
    @task
    def task_52(self):
        url = "http://26.234.8.159:5173/src/views/News/NewsDetail.vue"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': '*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/src/router/index.ts'}
        params = {}
        # null
        data = None
    ...
    def task_53(self):
        url = "http://26.234.8.159:5173/src/views/News/NewsDetail.vue"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': '*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/src/views/News/NewsDetail.vue'}
        params = {}
        params['type']='style'
        params['index']='0'
        params['scoped']='76f769dd'
        params['vue']=''
        params['lang.scss']=''
        # null
        data = None
    ...
    @task
    def task_54(self):
        url = "http://localhost:8080/get_newsdetail"
        ...
        params = {}
        params['title']='国际电联启动6G标准制定，中国提交35%关键技术提案'
        # null
        data = None
        res = self.get(url, headers=headers, params=params, data=data)
    ...
    @task
    def task_55(self):
        url = "http://localhost:8080/modify_view"
        headers = {'Host': 'localhost:8080', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'application/json, text/plain, */*', 'Accept-Language': 'en-US,en;q=0.5', 'Origin': 'http://26.234.8.159:5173', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/', 'Sec-Fetch-Dest': 'empty', 'Sec-Fetch-Mode': 'cors', 'Sec-Fetch-Site': 'cross-site'}
        params = {}
        params['title']='国际电联启动6G标准制定，中国提交35%关键技术提案'
        # null
    ...
    @task
    def task_56(self):
        url = "http://localhost:8080/api/comments/news/25/time"
        headers = {'Host': 'localhost:8080', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'application/json, text/plain, */*', 'Accept-Language': 'en-US,en;q=0.5', 'Origin': 'http://26.234.8.159:5173', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/', 'Sec-Fetch-Dest': 'empty', 'Sec-Fetch-Mode': 'cors', 'Sec-Fetch-Site': 'cross-site'}
        params = {}
        params['page']='1'
        params['size']='10'
    ...
    @task
    def task_60(self):
        url = "http://26.234.8.159:5173/src/assets/videos/bdbf6850-8d78-44d9-b858-429487b51c28.jpg"
        headers = {'Host': '26.234.8.159:5173', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'image/avif,image/webp,*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/news'}
        params = {}
        # null
        data = None
    ...
    def task_61(self):
        ...
        headers = {'Host': 'localhost:8080', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'application/json, text/plain, */*', 'Accept-Language': 'en-US,en;q=0.5', 'Origin': 'http://26.234.8.159:5173', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/', 'Sec-Fetch-Dest': 'empty', 'Sec-Fetch-Mode': 'cors', 'Sec-Fetch-Site': 'cross-site'}
        params = {}
        params['title']='全球互联网用户突破50亿大关，移动端占比达78%'
        # null
        data = None
        res = self.get(url, headers=headers, params=params, data=data)
        # application/json,res.json()
    ...
    @task
    def task_63(self):
        url = "http://localhost:8080/api/comments/news/15/time"
        headers = {'Host': 'localhost:8080', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'application/json, text/plain, */*', 'Accept-Language': 'en-US,en;q=0.5', 'Origin': 'http://26.234.8.159:5173', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/', 'Sec-Fetch-Dest': 'empty', 'Sec-Fetch-Mode': 'cors', 'Sec-Fetch-Site': 'cross-site'}
        params = {}
        params['page']='1'
        params['size']='10'
    ...
    def task_65(self):
        ...
        headers = {'Host': 'localhost:8080', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'application/json, text/plain, */*', 'Accept-Language': 'en-US,en;q=0.5', 'Content-Type': 'application/json', 'Content-Length': '85', 'Origin': 'http://26.234.8.159:5173', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/', 'Sec-Fetch-Dest': 'empty', 'Sec-Fetch-Mode': 'cors', 'Sec-Fetch-Site': 'cross-site'}
        params = {}
    ...
    def task_68(self):
        ...
        headers = {'Host': 'localhost:8080', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'application/json, text/plain, */*', 'Accept-Language': 'en-US,en;q=0.5', 'Origin': 'http://26.234.8.159:5173', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/', 'Sec-Fetch-Dest': 'empty', 'Sec-Fetch-Mode': 'cors', 'Sec-Fetch-Site': 'cross-site'}
        params = {}
        params['title']='美团无人机配送实现深圳全覆盖，时效提升至15分钟'
        # null
        data = None
        res = self.get(url, headers=headers, params=params, data=data)
        # application/json,res.json()
    ...
    @task
    def task_70(self):
        url = "http://localhost:8080/api/comments/news/19/time"
        headers = {'Host': 'localhost:8080', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/113.0', 'Accept': 'application/json, text/plain, */*', 'Accept-Language': 'en-US,en;q=0.5', 'Origin': 'http://26.234.8.159:5173', 'Connection': 'keep-alive', 'Referer': 'http://26.234.8.159:5173/', 'Sec-Fetch-Dest': 'empty', 'Sec-Fetch-Mode': 'cors', 'Sec-Fetch-Site': 'cross-site'}
        params = {}
        params['page']='1'
        params['size']='10'
